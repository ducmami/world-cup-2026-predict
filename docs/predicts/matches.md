...
> Cập nhật kết quả: 2026-07-15 16:26:26 UTC
...
| 2026/06/12 | South Korea | Czechia |
| ---------- | ----------- | ------- |
| Hiệp chính | 2           | 1       |
| Hiệp phụ   |             |         |
| Penalty    |             |         |
...
| 2026/06/15 | Spain | Cape Verde Islands |
| ---------- | ----- | ------------------ |
| Hiệp chính | 0     | 0                  |
| Hiệp phụ   |       |                    |
| Penalty    |       |                    |
...
| 2026/06/21 | Uruguay | Cape Verde Islands |
| ---------- | ------- | ------------------ |
| Hiệp chính | 2       | 2                  |
| Hiệp phụ   |         |                    |
| Penalty    |         |                    |
...
| 2026/06/27 | Cape Verde Islands | Saudi Arabia |
| ---------- | ------------------ | ------------ |
| Hiệp chính | 0                  | 0            |
| Hiệp phụ   |                    |              |
| Penalty    |                    |              |
...
| 2026/07/10 | Spain | Belgium |
| ---------- | ----- | ------- |
| Hiệp chính | 2     | 1       |
| Hiệp phụ   |       |         |
| Penalty    |       |         |

| 2026/07/11 | Norway | England |
| ---------- | ------ | ------- |
| Hiệp chính | 1      | 1       |
| Hiệp phụ   | 0      | 1       |
| Penalty    |        |         |
...
| 2026/07/14 | France | Spain |
| ---------- | ------ | ----- |
| Hiệp chính | 0      | 2     |
| Hiệp phụ   |        |       |
| Penalty    |        |       |

| 2026/07/15 | England | Argentina |
| ---------- | ------- | --------- |
| Hiệp chính |         |           |
| Hiệp phụ   |         |           |
| Penalty    |         |           |
